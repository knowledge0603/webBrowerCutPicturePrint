...
namespace CSharpWin_JD.CaptureImage
{
    ...
    public partial class DrawToolsControl : UserControl
    {
        ...
        private static readonly object EventButtonPrintClick = new object();
        ...
        {
            add { base.Events.AddHandler(EventButtonPrintClick, value); }
            remove { base.Events.RemoveHandler(EventButtonPrintClick, value); }
        }
        ...
        protected virtual void OnButtonPrintClick(EventArgs e)
        {
            EventHandler handler =
                base.Events[EventButtonPrintClick] as EventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
            ...
            object sender, ToolStripItemClickedEventArgs e)
        {
            switch (e.ClickedItem.Name)
            {
                ...
                case "toolStripButtonExit":
                    OnButtonExitClick(e);
                    break;
                case "toolStripButtoPrint":
                    OnButtonPrintClick(e);
                    break;
